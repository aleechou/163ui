...
-- Waterfall --
---------------
L["RatingBuster Options"] = "装备属性换算选项"
L["RatingBuster"] = "装备属性换算"
L["Enabled"] = "启用"
...
-- /rb hidebzcomp
L["Hide Blizzard Item Comparisons"] = "隐藏自带的物品比较"
L["Disable Blizzard stat change summary when using the built-in comparison tooltip"] = "不显示暴雪自带的装备后总属性变化的提示信息"
-- /rb statmod
L["Enable Stat Mods"] = "属性加成"
L["Enable support for Stat Mods"] = "启用属性加成计算"
-- /rb subtract_equip
L["Enable Subtract Equipped Stats"] = "启用精确相对计算"
L["Enable for more accurate calculation of Mana Regen from Intellect and Spirit, and diminishing stats like Dodge, Parry, Resilience"] = "统计精神及三维时会考虑目前的智力及三维的递减性，获得针对当前人物属性的精确信息。"
-- /rb enable_reforge_ui
L["Enable integration with Blizzard Reforging UI"] = "整合到暴雪重铸界面"
L["Add rating informatoin to the Blizzard Reforging UI"] = "在暴雪重铸界面上显示等级信息"
-- /rb usereqlv
...
-- /rb ilvlid
L["Item Level and ID"] = "物品等级和ID"
L["Settings for Item Level and Item ID"] = "物品等级和ID设置"
...
L["Show Item Level on all items"] = "显示所有物品的物品等级"
L["Display the Item Level on all items instead of just on equippable items"] = "在所有物品而不仅仅是已装备物品上显示物品等级"
-- /rb ilvlid itemid
L["Show Item ID"] = "显示物品ID"
L["Display the Item ID on all items"] = "在所有物品上显示物品ID"
---------------------------------------------------------------------------
-- /rb rating
L["Rating"] = "属性等级"
...
L["Select when to show rating conversions in tooltips. Modifier keys needs to be pressed before showing the tooltips."] = "设置显示等级和百分比转换的热键，或者不需热键永远显示。"
-- /rb rating spell
...
-- /rb stat agi crit
L["Show Crit"] = "显示爆击"
L["Show Crit chance from Agility"] = "显示敏捷给的爆击几率"
-- /rb stat agi dodge
L["Show Dodge"] = "显示躲闪"
L["Show Dodge chance from Agility"] = "显示敏捷给的躲闪几率"
-- /rb stat agi ap
L["Show Attack Power"] = "显示攻击强度"
L["Show Attack Power from Agility"] = "显示敏捷给的攻击强度"
-- /rb stat agi rap
...
L["Show Spell Crit chance from Spirit"] = "显示精神给的法术暴击一击机率"
...
L["Show Spell Hit from Spirit"] = "显示精神给的法术命中机率"
---------------------------------------------------------------------------
-- /rb stat armor
L["Armor"] = "护甲"
...
L["Minimum Item Quality"] = "最低物品质量"
L["Show stat summary only for selected quality items and up"] = "只在你所选的质量或更好的物品上显示属性统计"
-- /rb sum ignore armor
L["Armor Types"] = "护甲种类"
...
L["Hide stat summary for equipped items"] = "隐藏已装备的物品的属性统计"
-- /rb sum ignore enchant
L["Ignore Enchants"] = "忽略附魔"
L["Ignore enchants on items when calculating the stat summary"] = "统计时忽略物品上的附魔效果"
-- /rb sum ignore gem
L["Ignore Gems"] = "忽略宝石"
L["Ignore gems on items when calculating the stat summary"] = "统计时忽略物品上的宝石效果"
-- /rb sum ignore prismaticSocket
L["Ignore Prismatic Sockets"] = "忽略多彩插槽"
L["Ignore gems in prismatic sockets when calculating the stat summary"] = "统计时忽略多彩插槽里的宝石效果"
-- /rb sum diffstyle
...
-- /rb sum spell power
L["Sum Spell Power"] = "统计法术能量"
L["Spell Power <- Spell Power, Intellect, Agility, Strength"] = "法术能量 ← 法术伤害、智力、精神、耐力"
-- /rb sum spell dmg
...
L["Default Gem Set 1"] = "宝石设定 1"
L["Default Gem Set 2"] = "宝石设定 2"
L["Default Gem Set 3"] = "宝石设定 3"
-- /rb sum gem
...
L["Invalid input: %s. ItemID or ItemLink required."] = "输入错误：%s，请输入物品编号或物品连结。"
...
L["statList"] = {
	...
	{pattern = "防御", id = CR_DEFENSE_SKILL},
	{pattern = "躲闪", id = CR_DODGE},
	{pattern = "格挡", id = CR_BLOCK}, -- block enchant: "+10 Shield Block Rating"
	{pattern = "招架", id = CR_PARRY},

	{pattern = "法术爆击", id = CR_CRIT_SPELL},
	{pattern = "法术爆击命中", id = CR_CRIT_SPELL},
	{pattern = "法术爆击", id = CR_CRIT_SPELL},
	{pattern = "远程爆击", id = CR_CRIT_RANGED},
	{pattern = "远程爆击命中", id = CR_CRIT_RANGED},
	{pattern = "远程爆击", id = CR_CRIT_RANGED},
	{pattern = "近战爆击", id = CR_CRIT_MELEE},
	{pattern = "爆击", id = CR_CRIT_MELEE},

	{pattern = "法术命中", id = CR_HIT_SPELL},
	{pattern = "远程命中", id = CR_HIT_RANGED},
	{pattern = "命中", id = CR_HIT_MELEE},

	{pattern = "韧性", id = COMBAT_RATING_RESILIENCE_PLAYER_DAMAGE_TAKEN}, -- resilience is implicitly a rating

	{pattern = "法术急速", id = CR_HASTE_SPELL},
	{pattern = "远程急速", id = CR_HASTE_RANGED},
	{pattern = "急速", id = CR_HASTE_MELEE},
	{pattern = "加速", id = CR_HASTE_MELEE}, -- [Drums of Battle]

	{pattern = "武器技能", id = CR_WEAPON_SKILL},
	{pattern = "精准", id = CR_EXPERTISE},

	{pattern = "命中躲闪", id = CR_HIT_TAKEN_MELEE},
	{pattern = "护甲穿透", id = CR_ARMOR_PENETRATION},
