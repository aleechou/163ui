...
--	Recount.db2 = acedb:New("RecountPerCharDB", DefaultConfig)
	...
	AceConfigDialog:AddToBlizOptions("Recount Profile", "Profile", L["Recount"])
	AceConfigDialog:AddToBlizOptions("Recount Report", "Report", L["Recount"])
	AceConfigDialog:AddToBlizOptions("Recount Realtime", "Realtime", L["Recount"])
