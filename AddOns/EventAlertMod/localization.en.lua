...
EA_TTIP_SPECFLAG_CHECK_RAGE = "Show Rage in the left 1st position of Slef-Buffs";				-- ¤ä´©«ã®ð(¾Ô¤h,ºµD)
EA_TTIP_SPECFLAG_CHECK_FOCUS = "Show Focus in the left 1st position of Slef-Buffs";				--  ¤ä´©¶°¤¤­È(Ây¤H)
EA_TTIP_SPECFLAG_CHECK_ENERGY = "Show Energy in the left 1st position of Slef-Buffs";			--  ¤ä´©¯à¶q(¸é,¿ßD,ªZ¹¬)
EA_TTIP_SPECFLAG_CHECK_LIGHTFORCE = "Show Chi of Monk in the left 1st position of Self-Buffs";	--  ¤ä´©ªZ¹¬¯u®ð
EA_TTIP_SPECFLAG_CHECK_SHADOWORBS = "Show Shadow Orbs in the left 1st position of Slef-Buffs";	--  ¤ä´©·t¼vÄ_¯](·tªª)
