...
--[[1526]] L["因为5.0系统的改动，战斗中无法加载插件，战斗结束后会继续。如果不想使用延迟加载，请到控制台'有爱设置'中，关闭'进入世界后再加载插件'的选项。"] = "因為5.0系統的改動，戰鬥中無法加載插件，战斗结束后會繼續。如果不想使用延遲加載，請到控制台'有愛設置'中，關閉'進入世界後再加載插件'的選項。"
--[[1536]] L["还有至少["] = "還有至少["
...
--[[   9]] L['加载此配置需要重载界面，当前的插件中心设置将丢失，您确定吗？'] = '載入此配置需要重載介面，當前的插件中心設置將丟失，您確定嗎？'
--[[  22]] L['即将恢复网易有爱的默认设置，当前的插件中心设置将丢失，您确定吗？'] = '即將恢復網易有愛的默認設置，當前的插件中心設置將丟失，您確定嗎？'
--[[  73]] L["网易有爱插件配置方案"] = "網易有愛插件配置方案"
--[[  77]] L["方案列表"] = "方案列表"
--[[  81]] L["自动保存"] = "自動保存"
--[[  83]] L["角色登出、加载方案之前，会自动保存当前设置"] = "角色登出、載入方案之前，會自動保存當前設置"
--[[  91]] L["新建方案"] = "新建方案"
--[[  93]] L["恢复默认"] = "恢復默認"
--[[ 159]] --L["未知"] = "未知"
--[[ 174]] L["方案: "] = "方案: "
...
--[[ 231]] L["插件状态"] = "插件狀態"
--[[ 232]] --L["说明"] = "說明"
--[[ 232]] L["选中此项则会保存/加载目前启用的插件列表"] = "選中此項則會保存/載入目前啟用的插件列表"
--[[ 233]] L["插件配置"] = "插件配置"
--[[ 234]] --L["说明"] = "說明"
--[[ 234]] L["选中此项则会保存/加载有爱插件控制台里的所有设置项"] = "選中此項則會保存/載入有愛插件控制台裡的所有設置項"
--[[ 244]] L['改名'] = '改名'
--[[ 247]] L["未命名"] = "未命名"
--[[ 287]] L['加载'] = '載入'
--[[ 304]] L['删除'] = '刪除'
