U1RegisterAddon("!tdDropDown", {
    ...
    toggle = function(name, info, enable, justload)
        if enable then
            ...
            if IsAddOnLoaded("Blizzard_EncounterJournal") or "MISSING"==select(6, GetAddOnInfo("Blizzard_EncounterJournal")) then U1SimulateEvent("ADDON_LOADED", "Blizzard_EncounterJournal"); end
        end
        return true;
    end,
    ------- Options --------
