...
U1RegisterAddon("SwingBar", {
    title = "近战攻击条",
    defaultEnable = (class=="WARRIOR" or class=="PALADIN" or class=="DEATHKNIGHT" or class=='MONK') and 1 or 0,
    frames = {"SwingBar"},

    tags = { TAG_GOOD, TAG_CLASS, TAG_WARRIOR, TAG_PALADIN, TAG_ROGUE, TAG_DEATHKNIGHT, TAG_DRUID, TAG_SHAMAN, TAG_MONK, },
