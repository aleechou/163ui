...
function ModelItem:UpdateYiXinFans()
    ...
    GUI:SetTooltip(YiXinButton, 'ANCHOR_RIGHT', L['在|cff00ffff易信|r中关注Ta仅需两步：'], ' ', L['1.下载易信并关注公众号“|cffffd100友团插件|r”'], (L['2.向“|cffffd100友团插件|r”发送“|cffffd100关注%s@%s|r”即可']):format(_G.UnitFullName(unitId)), ' ', L['点击查看详细步骤'])
end
