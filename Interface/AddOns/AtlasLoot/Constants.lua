...
-- colors
ATLASLOOT_COLLECTION_COLOR = {0, 1, 0, 1}
ATLASLOOT_CRAFTING_COLOR = {1, 1, 0, 1}
ATLASLOOT_DUNGEON_COLOR = {0, 0, 1, 1}
ATLASLOOT_PVP_COLOR = {0, 1, 1, 1}
ATLASLOOT_RAID_COLOR = {1, 0, 0, 1}
ATLASLOOT_REMOVED_COLOR = {1, 0.54, 0, 1}
ATLASLOOT_UNKNOWN_COLOR = {0, 0, 0, 1}
ATLASLOOT_WORLDEVENTS_COLOR = {1, 0, 1, 1}
