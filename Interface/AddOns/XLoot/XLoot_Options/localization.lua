...
locales.deDE["alpha"] = "Deckkarft" -- Needs review
locales.deDE["confirm_reset_profile"] = "Dies wird alle Einstellungen für dieses Profil löschen. Bist du sicher?" -- Needs review
...
locales.deDE["scale"] = "Maßstab" -- Needs review
locales.deDE["up"] = "Hoch" -- Needs review
locales.deDE["visible"] = "Sichtbar" -- Needs review
locales.deDE["when_always"] = "Immer" -- Needs review
locales.deDE["when_auto"] = "Automatisch" -- Needs review
locales.deDE["when_grouped"] = "In Gruppe" -- Needs review
locales.deDE["when_never"] = "Niemals" -- Needs review
...
locales.deDE.Frame = {
	...
	autoloot_coin_desc = "Wann sollen automatisch Münzen geplündert werden", -- Needs review
 ...
 Beispiel: Leinenstoff, Aschenbringer, Kupfererz]=], -- Needs review
	...
	autoloot_quest_desc = "Wann sollen automatisch Quest-Gegenstände geplündert werden", -- Needs review
	colors = "Farben", -- Needs review
	font = "Font", -- Needs review
	fonts = "Fonts", -- Needs review
	font_size_bottombuttons = "Verknüpfe alle/Schließe", -- Needs review
	...
	frame_color_backdrop = "Rahmen Hintergrundfarbe", -- Needs review
	frame_color_border = "Rahmen außenrand Farbe", -- Needs review
	frame_color_gradient = "Rahmenfarbverlauf", -- Needs review
	frame_draggable = "Beute Fenster verschiebbar", -- Needs review
	frame_grow_upwards = "Erweitere Rahmen aufwärts", -- Needs review
	frame_options = "Rahmen Optionen", -- Needs review
	frame_snap = "Binde Rahmen an Maus", -- Needs review
	...
	frame_width = "Rahmen breite", -- Needs review
	frame_width_automatic = "Rahmen automatisch erweitern", -- Needs review
	linkall_channel = "Standard verlinkungs Chatkanal", -- Needs review
	linkall_show = "Sichtbarkeit des Verknüpfungsknopfs", -- Needs review
	linkall_threshold = "Minimale Anzahl die im Chat verknüpft wird", -- Needs review
	link_button = "Verbinde alle Knopf", -- Needs review
	loot_collapse = "Schließe geplünderte Slots", -- Needs review
	loot_color_backdrop = "Beute Hintergrundfarbe", -- Needs review
	loot_color_border = "Beute Rahmenfarbe", -- Needs review
	...
	loot_texts_info = "Zeige detailierte Informationen", -- Needs review
	...
	quality_color_frame = "Färbe Rahmenfarbe nach höchster Qualität", -- Needs review
	quality_color_slot = "Färbe Beute Rahmen nach Qaulität", -- Needs review
	slot_options = "Beute Slots", -- Needs review
}
locales.deDE.Group = {
	alert_anchor_visible = "Beute Popup Anker sichtbar", -- Needs review
	alert_anchor_visible_desc = "Bezieht sich auf \"Du erhälst ..\" Rahmen, oder \"Warnmeldungen\"", -- Needs review
	alert_offset = "Vertikaler abstand", -- Needs review
	alerts = "Beute Warnungen", -- Needs review
	alert_skin = "Optik Beute Popup Rahmen", -- Needs review
	alert_skin_desc = "Bezieht sich auf \"Du erhälst ..\" Rahmen, oder \"Warnmeldungen\"", -- Needs review
	anchors = "Anker", -- Needs review
	bonus_skin = "Oberfläche des Bonus Wurf Rahmens", -- Needs review
	...
	roll_anchor_visible = "Wurf Anker sichtbar", -- Needs review
	roll_button_size = "Wurf-Knopf-Größe", -- Needs review
	rolls = "Wurf Rahmen", -- Needs review
	roll_tracking = "Welche Würfe sollen gezeigt werden", -- Needs review
	roll_width = "Wurf Rahmen breite", -- Needs review
	show_decided = "Zeige entscheidung", -- Needs review
	show_undecided = "Führe wartende Spieler auf", -- Needs review
	show_undecided_desc = "Führe Spieler auf die nicht gewählt haben wie sie Würfeln", -- Needs review
...
locales.deDE.Master = {
	...
	award_guildannounce = "Echo in Gilden Chat", -- Needs review
	award_qualitythreshold = "Minimale Qualität melden", -- Needs review
	award_special = "Melde speziele Empfänger", -- Needs review
	confirm_qualitythreshold = "Bestätige minimale Qualität", -- Needs review
	menu_bank = "Zeige Bank", -- Needs review
...
locales.deDE.Monitor = {
	...
	fading = "Reihen ausblend dauer (in Sekunden)", -- Needs review
...
locales.ruRU.Frame = {
	autoloot_all = "Автоматически собирать добычу", -- Needs review
	...
	frame_grow_upwards = "Расширять фреймы вверх", -- Needs review
	...
	loot_collapse = "Закрывать собранные слоты", -- Needs review
	...
	loot_texts_bind = "Показывать при каких условиях добыча станет персональной", -- Needs review
	loot_texts_info = "Показывать детальную информацию",
	loot_texts_lock = "Показывать статус блокировки", -- Needs review
...
locales.ruRU.Group = {
	alert_anchor_visible = "Видимость \"якоря\" всплывающего фрейма добычи", -- Needs review
	alert_anchor_visible_desc = "Относится к фреймам  или 'оповещениям' 'Вы выйграли..'", -- Needs review
	alert_offset = "Вертикальный интервал",
	alerts = "Оповещение о добыче",
	alert_skin = "Скин для всплывающих фреймов добычи", -- Needs review
	alert_skin_desc = "Относится к фреймам  или 'оповещениям' 'Вы выиграли..'", -- Needs review
	anchors = "\"Якоря\"",
	bonus_skin = "Скин фрейма броска для бонусной добычи", -- Needs review
...
locales.ruRU.Master = {
	...
	award_special = "Объявлять об особых получателях", -- Needs review
