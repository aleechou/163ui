...
local sndQS		= mod:NewSound(nil, mod:IsHealer(), "SoundQS")
...
local function warnCorruptedPrisonTargets()
	...
	sndWOP:Play("Interface\\AddOns\\DBM-Sound-Yike\\yike\\helpme.ogg") --救我
end
...
--	countdownReflection:Start(-delay)
	sndWOP:Schedule(21-delay, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\mobsoon.ogg") --準備小怪
	sndWOP:Schedule(22.5-delay, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countthree.ogg")
	sndWOP:Schedule(23.5-delay, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\counttwo.ogg")
	sndWOP:Schedule(24.5-delay, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countone.ogg")
	timerCorruptedPrisonCD:Start(-delay)
	sndWOP:Schedule(40-delay, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\readyrescue.ogg") --準備救人
	timerManifestationCD:Start(-delay)
	sndWOP:Schedule(60-delay, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\bigmobsoon.ogg") --準備大怪
	specWarnManifestation:Schedule(64-delay)
	if mod:IsDps() then
		sndWOP:Schedule(64-delay, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\killbigmob.ogg")--大怪快打
	else
		sndWOP:Schedule(64-delay, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\bigmob.ogg")--大怪出現
	end
	timerSwellingPrideCD:Start(-delay, 1)
--	countdownSwellingPride:Start(-delay)
	sndWOP:Schedule(72.5-delay, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\aesoon.ogg") --準備AOE
	sndWOP:Schedule(73.5-delay, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countthree.ogg")
	sndWOP:Schedule(74.5-delay, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\counttwo.ogg")
	sndWOP:Schedule(75.5-delay, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countone.ogg")
	...
	if args.spellId == 144400 then
		...
		if MyJS() then
			...
			if (playerpower >= 50) and (playerpower < 75) then
				sndWOP:Play("Interface\\AddOns\\DBM-Sound-Yike\\yike\\ex_so_zbty.ogg") --準備投影
...
--		countdownReflection:Cancel()
		sndWOP:Play("Interface\\AddOns\\DBM-Sound-Yike\\yike\\ptwo.ogg") --P2
		sndWOP:Cancel("Interface\\AddOns\\DBM-Sound-Yike\\yike\\aesoon.ogg")
...
--		countdownReflection:Start()
		...
		sndWOP:Schedule(21, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\mobsoon.ogg") --準備小怪
		sndWOP:Schedule(22.5, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countthree.ogg")
		sndWOP:Schedule(23.5, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\counttwo.ogg")
		sndWOP:Schedule(24.5, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countone.ogg")
		timerCorruptedPrisonCD:Start()
		sndWOP:Cancel("Interface\\AddOns\\DBM-Sound-Yike\\yike\\readyrescue.ogg")
		sndWOP:Schedule(40, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\readyrescue.ogg") --準備救人			
		if self:IsMythic() then
...
--		countdownReflection:Start()
		...
		sndWOP:Schedule(60, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\bigmobsoon.ogg") --準備大怪
		specWarnManifestation:Schedule(64)
		if mod:IsDps() then
			sndWOP:Schedule(64, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\killbigmob.ogg")--大怪快打
		else
			sndWOP:Schedule(64, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\bigmob.ogg")--大怪出現
		end		
		timerSwellingPrideCD:Start(75, swellingCount + 1)
--		countdownSwellingPride:Start()
		sndWOP:Schedule(72.5, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\aesoon.ogg") --準備AOE
		sndWOP:Schedule(73.5, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countthree.ogg")
		sndWOP:Schedule(74.5, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\counttwo.ogg")
		sndWOP:Schedule(75.5, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countone.ogg")
		if self:IsMythic() then
			timerBanishmentCD:Start()
		end
...
--		countdownSwellingPride:Cancel()
		...
		specWarnManifestation:Schedule(64)
		sndWOP:Cancel("Interface\\AddOns\\DBM-Sound-Yike\\yike\\bigmobsoon.ogg")		
		sndWOP:Schedule(60, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\bigmobsoon.ogg") --準備大怪		
		if mod:IsDps() then
			sndWOP:Cancel("Interface\\AddOns\\DBM-Sound-Yike\\yike\\killbigmob.ogg")
			sndWOP:Schedule(64, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\killbigmob.ogg")--大怪快打
		else
			sndWOP:Cancel("Interface\\AddOns\\DBM-Sound-Yike\\yike\\bigmob.ogg")
			sndWOP:Schedule(64, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\bigmob.ogg")--大怪出現
		end
...
--		countdownSwellingPride:Start(75)--Not yet verified if altered or not (it would be 62 instead of 60 though since we'd be starting at 0 energy instead of cast finish of last swelling)
		sndWOP:Schedule(72, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\aesoon.ogg") --準備AOE
		sndWOP:Schedule(73, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countthree.ogg")
		sndWOP:Schedule(74, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\counttwo.ogg")
		sndWOP:Schedule(75, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countone.ogg")
...
function mod:SPELL_AURA_APPLIED(args)
	if args:IsSpellID(144359, 146594) then
		...
		if args:IsPlayer() then
			...
			sndWOP:Play("Interface\\AddOns\\DBM-Sound-Yike\\yike\\ex_so_ttzc.ogg") --泰坦之賜
			if mod:IsHealer() then
				sndWOP:Schedule(1, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\dispelnow.ogg") --快驅散
			else
				sndWOP:Schedule(1, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\gather.ogg") --快集合
			end
			TTbuff = true
		end
	elseif args.spellId == 145215 then
		...
		if args:IsPlayer() then
			...
			sndWOP:Play("Interface\\AddOns\\DBM-Sound-Yike\\yike\\banishment.ogg") --你被放逐
		end
	elseif args.spellId == 146822 then
		...
		if args:IsPlayer() then
			...
			sndWOP:Play("Interface\\AddOns\\DBM-Sound-Yike\\yike\\ex_so_kjty.ogg") --快進投影
			sndWOP:Schedule(1, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\ex_so_kjty.ogg")
			sndWOP:Schedule(2, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countfive.ogg")
			sndWOP:Schedule(3, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countfour.ogg")
			sndWOP:Schedule(4, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countthree.ogg")
			sndWOP:Schedule(5, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\counttwo.ogg")
			sndWOP:Schedule(6, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countone.ogg")
		end
	...
	elseif args.spellId == 144843 then--Same spellid fires for both versions, so we have to do some more advanced filtering
		if bit.band(args.destFlags, COMBATLOG_OBJECT_REACTION_HOSTILE) ~= 0 then--Mind controled version
			...
			if args:IsPlayer() then
				...
				sndWOP:Play("Interface\\AddOns\\DBM-Sound-Yike\\yike\\ex_so_aqym.ogg") --傲氣已滿
			end
		end
	...
	if args:IsPlayerSource() then
		self:Schedule(7.5, function()
			if mod:IsHealer() and TTbuff then
				sndQS:Play("Interface\\AddOns\\DBM-Sound-Yike\\yike\\dispelnow.ogg") --快驅散
			end
		end)
	end
end
...
function mod:UNIT_POWER(uId)
	...
	if playerpower >= 75 and not warnedpowerhigh then
		sndWOP:Play("Interface\\AddOns\\DBM-Sound-Yike\\yike\\ex_so_aqgg.ogg") --傲氣過高
