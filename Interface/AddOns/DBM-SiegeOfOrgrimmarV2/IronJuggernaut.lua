...
function mod:OnCombatStart(delay)
	...
	sndWOP:Schedule(117, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\ex_so_qgzb.ogg") --強攻階段準備
	sndWOP:Schedule(118, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countthree.ogg")
	sndWOP:Schedule(119, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\counttwo.ogg")
	sndWOP:Schedule(120, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countone.ogg")
...
function mod:SPELL_CAST_START(args)
	if args.spellId == 144483 then--Siege mode transition
		...
		sndWOP:Cancel("Interface\\AddOns\\DBM-Sound-Yike\\yike\\ex_so_qgzb.ogg")
		...
		sndWOP:Schedule(60, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\ex_so_tjzb.ogg") --突擊階段準備
		sndWOP:Schedule(61, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countthree.ogg")
		sndWOP:Schedule(62, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\counttwo.ogg")
		sndWOP:Schedule(63, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countone.ogg")
	elseif args.spellId == 144485 then
		...
		sndWOP:Play("Interface\\AddOns\\DBM-Sound-Yike\\yike\\ex_so_zbjt.ogg") --準備擊飞		
		if MyJS() then
			sndWOP:Schedule(1, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\defensive.ogg") --注意減傷
		else
...
function mod:UNIT_SPELLCAST_SUCCEEDED(uId, _, _, _, spellId)
	...
	elseif spellId == 144296 then--absolutely do NOT add 144218 to this. 144218 is an every 0.4 second periodic trigger that fires after 144296
		...
		sndWOP:Play("Interface\\AddOns\\DBM-Sound-Yike\\yike\\ex_so_dckd.ogg")--地刺快躲
	...
	elseif spellId == 144673 then
		...
		sndWOP:Play("Interface\\AddOns\\DBM-Sound-Yike\\yike\\ex_so_dlcx.ogg")--地雷出現
	...
	elseif spellId == 146359 then--Regeneration (Assault Mode power regen activation)
		...
		if siegeMode == true then--don't start timer on pull regenerate, pull regenerate is 5 seconds longer than rest of them
			...
			sndWOP:Cancel("Interface\\AddOns\\DBM-Sound-Yike\\yike\\ex_so_tjzb.ogg")
			sndWOP:Cancel("Interface\\AddOns\\DBM-Sound-Yike\\yike\\countthree.ogg")
			sndWOP:Cancel("Interface\\AddOns\\DBM-Sound-Yike\\yike\\counttwo.ogg")
			sndWOP:Cancel("Interface\\AddOns\\DBM-Sound-Yike\\yike\\countone.ogg")
			sndWOP:Play("Interface\\AddOns\\DBM-Sound-Yike\\yike\\phasechange.ogg") --階段轉換
			sndWOP:Schedule(112, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\ex_so_qgzb.ogg") --強攻階段準備
			sndWOP:Schedule(113, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countthree.ogg")
			sndWOP:Schedule(114, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\counttwo.ogg")
			sndWOP:Schedule(115, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countone.ogg")
			siegeMode = false
		end
		--[[if self:IsMythic() then
