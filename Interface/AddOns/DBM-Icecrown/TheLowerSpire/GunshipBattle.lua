...
function mod:SPELL_AURA_REMOVED(args)
	if args:IsSpellID(69705) then
		...
		sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\"..DBM.Options.CountdownVoice.."\\goodgun.mp3")
	end
end
...
function mod:SPELL_CAST_START(args)
	if args:IsSpellID(69705) then
		...
		sndWOP:Schedule(1, "Interface\\AddOns\\DBM-Core\\extrasounds\\"..DBM.Options.CountdownVoice.."\\badgun.mp3")
	end
end
