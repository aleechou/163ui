...
--[[1526]] L["因为5.0系统的改动，战斗中无法加载插件，战斗结束后会继续。如果不想使用延迟加载，请到控制台'有爱设置'中，关闭'进入世界后再加载插件'的选项。"] = true
--[[1536]] L["还有至少["] = true
...
--[[1141]] L["插件介绍"] = true
--[[1275]] L["插件分类："] = true
--[[1275]] L["<P>　%s<br/><br/></P><P>　%s</P></BODY></HTML>"] = true
--[[1276]] L["插件数："] = true
--[[1288]] L["<BR/>　"] = true
...
--[[   9]] L['加载此配置需要重载界面，当前的插件中心设置将丢失，您确定吗？'] = true
--[[  22]] L['即将恢复网易有爱的默认设置，当前的插件中心设置将丢失，您确定吗？'] = true
--[[  73]] L["网易有爱插件配置方案"] = true
--[[  77]] L["方案列表"] = true
--[[  81]] L["自动保存"] = true
--[[  83]] L["角色登出、加载方案之前，会自动保存当前设置"] = true
--[[  91]] L["新建方案"] = true
--[[  93]] L["恢复默认"] = true
--[[ 159]] --L["未知"] = true
--[[ 174]] L["方案: "] = true
...
--[[ 231]] L["插件状态"] = true
--[[ 232]] --L["说明"] = true
--[[ 232]] L["选中此项则会保存/加载目前启用的插件列表"] = true
--[[ 233]] L["插件配置"] = true
--[[ 234]] --L["说明"] = true
--[[ 234]] L["选中此项则会保存/加载有爱插件控制台里的所有设置项"] = true
--[[ 244]] L['改名'] = true
--[[ 247]] L["未命名"] = true
--[[ 287]] L['加载'] = true
--[[ 304]] L['删除'] = true
