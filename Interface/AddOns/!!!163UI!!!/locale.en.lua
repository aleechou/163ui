...
--[[1526]] L["因为5.0系统的改动，战斗中无法加载插件，战斗结束后会继续。如果不想使用延迟加载，请到控制台'有爱设置'中，关闭'进入世界后再加载插件'的选项。"] = "Some addons will be load after combat to awoid 'Script ran too long' error, or you can disable this feature in 'Settings'-'Load Addons after Entering World'."
...
--[[1275]] L["<P>　%s<br/><br/></P><P>　%s</P></BODY></HTML>"] = "<P>  %s<br/><br/></P><P>  %s</P></BODY></HTML>"
...
--[[ 147]] L["加载之前"] = "BeforeLoad"
--[[ 177]] L["登出"] = "Logout"

--[[    ]] -- File: ProfilesUI.lua

--[[   9]] L['加载此配置需要重载界面，当前的插件中心设置将丢失，您确定吗？'] = "Reloading is required to load this profile, all current addons settings of the control panel will be lost, are you SURE?"
--[[  22]] L['即将恢复网易有爱的默认设置，当前的插件中心设置将丢失，您确定吗？'] = "Abount to restore the default settings or NetEaseUI, all current addons settings of the control panel will be lost, are you SURE?"
--[[  73]] L["网易有爱插件配置方案"] = "NetEaseUI Addon Profiles"
--[[  77]] L["方案列表"] = "Saved"
--[[  81]] L["自动保存"] = "Auto"
--[[  83]] L["角色登出、加载方案之前，会自动保存当前设置"] = "NetEaseUI will save profile before logout or loading another profile."
--[[  91]] L["新建方案"] = "New Profile"
--[[  93]] L["恢复默认"] = "Default Settings"
--[[ 159]] --L["未知"] = true
--[[ 174]] L["方案: "] = "Profile"
--[[ 176]] L['插件数: '] = "Addons: "
--[[ 189]] L['%m月%d日'] = "%d/%m"
--[[ 195]] L['今天'] = "Today"
--[[ 217]] L['方案名称'] = "Profile Name"
--[[ 231]] L["插件状态"] = "Addon status"
--[[ 232]] --L["说明"] = true
--[[ 232]] L["选中此项则会保存/加载目前启用的插件列表"] = "Check if you want to save the enable/disable status of each addon."
--[[ 233]] L["插件配置"] = "Addon options"
--[[ 234]] --L["说明"] = true
--[[ 234]] L["选中此项则会保存/加载有爱插件控制台里的所有设置项"] = "Check if you want to save the settings in the control panel."
--[[ 244]] L['改名'] = "Rename"
--[[ 247]] L["未命名"] = "Unnamed"
--[[ 287]] L['加载'] = "Load"
--[[ 304]] L['删除'] = "Delete"
--[[ 306]] L['保存'] = 'Save'
--[[ 321]] L['新建方案名称：'] = "New profile name: "
--[[ 335]] L['修改方案名称：'] = "Change profile name: "
...
--[[  13]] L["进入世界后再加载插件"] = "Load Addons after Entering World"
