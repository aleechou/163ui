...
function mod:SPELL_CAST_START(args)
	if args:IsSpellID(107018) then
		...
		if firstAspect then
			...
			sndWOP:Schedule(11, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\"..GetLocale().."\\mutant.mp3")
		else
			...
			sndWOP:Schedule(17, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\"..GetLocale().."\\mutant.mp3")
		end	
	...
	elseif args:IsSpellID(108813) then
		if parasiteinvortex then
			...
			if UnitBuff("player", GetSpellInfo(106457)) and not UnitIsDeadOrGhost("player") and not self:IsTank() then--Check for Ysera's Presence
				sndWOP:Schedule(12, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\clickshield.mp3")
			end
			...
			if UnitBuff("player", GetSpellInfo(106457)) and not UnitIsDeadOrGhost("player") and not self:IsTank() then--Check for Ysera's Presence
				sndWOP:Schedule(7, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\clickshield.mp3")
			end
			sndWOP:Schedule(8, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countthree.mp3")
			sndWOP:Schedule(9, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\counttwo.mp3")
			sndWOP:Schedule(10, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countone.mp3")
		end
	end
end
...
function mod:SPELL_CAST_SUCCESS(args)
	if args:IsSpellID(105651) then
		...
		if not UnitBuff("player", GetSpellInfo(106027)) and not UnitIsDeadOrGhost("player") then--Check for Nozdormu's Presence
			...
			sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\boltappear.mp3")
			timerElementiumBlast:Start()
			sndWOP:Schedule(4, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\boomrun.mp3")
			...
			sndWOP:Schedule(5.5, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\boltappear.mp3")
			sndWOP:Schedule(15.5, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countthree.mp3")
			sndWOP:Schedule(16.5, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\counttwo.mp3")
			sndWOP:Schedule(17.5, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countone.mp3")
		end
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args:IsSpellID(106400) then
		...
		timerImpaleCD:Start()
--		sndWOP:Schedule(29, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\awaymutant.mp3")
		if args:IsPlayer() then
			...
			if not UnitBuff("player", GetSpellInfo(106457)) and not UnitIsDeadOrGhost("player") then--Check for Ysera's Presence
				...
				sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\clickshield.mp3")
			end
		else
	...
	elseif args:IsSpellID(106794) then
		...
		if args:IsPlayer() then
			...
			yellShrapnel:Yell()
			timerShrapnel:Start()
			sndWOP:Schedule(1.5, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\clickshield.mp3")
	...
	elseif args:IsSpellID(108649) then
		...
		elseif self:IsHealer() then
			sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\healparasite.mp3")
		end
...
function mod:SPELL_AURA_REMOVED(args)
	...
	elseif args:IsSpellID(108649) then
		...
		sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\killparasite.mp3")
...
function mod:SPELL_SUMMON(args)
	if args:IsSpellID(109091) and self:AntiSpam(10, 1) then
		...
		sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\aeblood.mp3")
	end
end
...
--		sndWOP:Cancel("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\awaymutant.mp3")
		timerImpale:Cancel()
...
function mod:UNIT_SPELLCAST_SUCCEEDED(uId, _, _, _, spellId)
	...
	elseif spellId == 105551 and self:AntiSpam(2, 2) then--Spawn Blistering Tentacles
		...
		if not UnitBuff("player", GetSpellInfo(106028)) then--Check for Alexstrasza's Presence
			...
			sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\blisterling.mp3")
		end
