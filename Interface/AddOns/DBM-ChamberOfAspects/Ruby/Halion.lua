...
--			soundConsumption:Play()
			...
			sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\"..DBM.Options.CountdownVoice.."\\shadowmark.mp3")
		end
...
--			soundConsumption:Play()
			...
			sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\"..DBM.Options.CountdownVoice.."\\firemark.mp3")
		end
		if not self.Options.AnnounceAlternatePhase then
...
function mod:CHAT_MSG_RAID_BOSS_EMOTE(msg)
	if msg == L.twilightcutter or msg:find(L.twilightcutter) then
		...
		if not self.Options.AnnounceAlternatePhase then
			...
			sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\"..DBM.Options.CountdownVoice.."\\cutsoon.mp3")
			...
			sndWOP:Schedule(2.8, "Interface\\AddOns\\DBM-Core\\extrasounds\\"..DBM.Options.CountdownVoice.."\\countone.mp3")			
			sndWOP:Schedule(3.3, "Interface\\AddOns\\DBM-Core\\extrasounds\\"..DBM.Options.CountdownVoice.."\\cutnow.mp3")
