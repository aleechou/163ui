...
--group:AddButton(L["hide direction arrow"], "hideDirectionArrow") --fishuiedit 
group:AddButton(L["invert bar color"], "invertColor", 1) --fishuiedit
...
local function InitOptionData(db, chardb)
	...
	if not db.v30 then
		...
		db.raidFilter = "CLASS"
		db.clickDownMode = 1  --fishuiedit
		chardb.showPartyPets = 0  --fishuiedit
	end
	...
	--LoadOption("hideDirectionArrow") --fishuiedit 
