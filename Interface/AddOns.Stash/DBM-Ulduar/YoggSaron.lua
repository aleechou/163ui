...
function mod:SPELL_CAST_START(args)
	if args.spellId == 64059 then	-- Induce Madness
		...
		sndWOP:Schedule(78, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\indoorsoon.mp3")
		specWarnMadnessOutNow:Schedule(55)
		sndWOP:Schedule(55, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\outdoornow.mp3")
	elseif args.spellId == 64189 then		--Deafening Roar
		timerNextDeafeningRoar:Start()
		warnDeafeningRoarSoon:Schedule(55)
		sndWOP:Schedule(55, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\silencesoon.mp3")
...
function mod:SPELL_AURA_APPLIED(args)
	if args.spellId == 63802 then		-- Brain Link
		...
		if args:IsPlayer() then
			...
			sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\followline.mp3")
		end
	...
	elseif args:IsSpellID(64126, 64125) then	-- Squeeze
		...
		sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\killmhand.mp3")
	...
	elseif args.spellId == 63138 then	-- Sara's Fervor
		...
		if args:IsPlayer() then 
			specWarnFervor:Show()
			sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\fever.mp3")
		end
	elseif args.spellId == 63894 then	-- Shadowy Barrier of Yogg-Saron (this is happens when p2 starts)
		...
		sndWOP:Schedule(57, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\indoorsoon.mp3")
		warnP2:Show()
		if self.Options.ShowSaraHealth then
	...
	elseif args.spellId == 64465 then
		...
		sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\marknow.mp3")
		...
		sndWOP:Schedule(40, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\marksoon.mp3")
	end
end
...
function mod:SPELL_AURA_REMOVED(args)
	...
	elseif args:IsSpellID(64167, 64163) then	-- Lunatic Gaze
		...
		sndWOP:Schedule(8, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\turnaround.mp3")
	end
end
...
function mod:OnSync(msg)
	if msg == "Phase3" then
		...
		warnEmpowerSoon:Schedule(40)
		sndWOP:Schedule(40, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\marksoon.mp3")
		sndWOP:Cancel("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\indoorsoon.mp3")
		timerNextDeafeningRoar:Start(30)
		warnDeafeningRoarSoon:Schedule(25)
		sndWOP:Schedule(25, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\silencesoon.mp3")
	end
end
